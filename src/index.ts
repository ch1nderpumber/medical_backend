...
app.use(express.static(path.join(__dirname, './view/panel')));
app.use(express.static(path.join(__dirname, './view/terminal')));

app.get('/terminal', (req, res) => {
	res.sendFile(path.join(__dirname, './view/terminal', 'index.html'));
});

app.get('/*', (req, res) => {
	res.sendFile(path.join(__dirname, './view/panel', 'index.html'));
});
